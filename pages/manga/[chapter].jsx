...
export default function Chapter({ chapterNumber, imageUrls, totalChapters, params, errorcode }) {
    ...
    const DESCRIPTION = `Enjoy reading ${MANGA_NAME} chapter ${chapterNumber} online at ${DOMAIN}. Asta, a young boy born without magic in a world where everyone else has it. He dreams of becoming the Wizard King and overcomes obstacles with his determination and unique anti-magic abilities.`
